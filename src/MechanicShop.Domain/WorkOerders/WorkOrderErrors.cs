...
public static class WorkOrderErrors
{
    ...
    public static  Error DiscountNegative => Error.Validation(
    code: "WorkOrderErrors.DiscountNegative",
    description: "Discount cannot be negative.");


    public static readonly Error CannotRemoveLastRepairTask = Error.Validation(
    code: "WorkOrderErrors.CannotRemoveLastRepairTask",
    description: "Work order must contain at least one repair task.");

    public static readonly Error RepairTaskNotFound = Error.NotFound(
        code: "WorkOrderErrors.RepairTaskNotFound",
        description: "The specified repair task was not found in this work order.");
}